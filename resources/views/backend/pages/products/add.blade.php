            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('store.products') }}" method="post" class="row g-3" id="myForm"
                                enctype="multipart/form-data">
                                @csrf

                                <div class="form-group col-md-4">
                                    <label for="bellnumber" class="form-label">مسلسل بل <span
                                            class="text-danger">*</span></label>
                                    <input type="number" class="form-control" name="bellnumber"
                                ...
                                <div class="form-group col-md-4">
                                    <label for="lastname" class="form-label">شماره تماس <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-md-4">
                                    <label for="date" class="form-label">تاریخ محفل <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="persianDate" class="form-control" name="date"
                                        value="1405/00/00">
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="price" class="form-label">مجموع مبلغ<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-md-4">
                                    <label for="paied" class="form-label">مبلغ پرداخت شده<span
                                            class="text-danger">*</span></label>
                                    <input type="number" class="form-control" id="paied" name="paied"
                                        placeholder="Enter Paid Amount">
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="remaining" class="form-label">مبلغ باقی مانده<span
                                            class="text-danger">*</span></label>
                                    <input type="number" class="form-control" id="remaining" name="remaining"
                                        placeholder="Enter Remaining Amount" readonly style="background-color: #e9ecef;">
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <img id="showImage" src="{{ url('upload/no_image.png') }}"
                                        class="rounded-circle avatar-xl img-thumbnail float-start" alt="image profile">
                                </div>


                                <div class="form-group col-md-4">
                                    <label for="remaining" class="form-label">سهم هوتل یا سهم بیرونی<span
                                            class="text-danger">*</span></label>
