...
<div class="content">
    <div class="container-xxl">
         ...
         <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            ...
            <div class="text-end">
                <a href="{{ route('all.debt') }}" class="btn btn-secondary">
                    لیست قرض ها
                </a>
            </div>
        </div>
            ...
            <div class="col-xl-12"> 
                <div class="card"> 
                    <div class="card-body"> 
                        ...
                        <form action="{{ route('store.debt') }}" method="post" class="row g-3">
                            @csrf
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="date" value="1400/00/00" class="form-control">
                            </div>
